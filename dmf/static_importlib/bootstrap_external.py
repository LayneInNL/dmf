...
# `make regen-static_importlib` followed by `make` in order to get the frozen version
...
def _validate_hash_pyc(data, source_hash, name, exc_details):
    ...
    *source_hash* is the static_importlib.util.source_hash() of the source file.
...
class _LoaderBasics:
    ...
    def exec_module(self, module):
        ...
        _bootstrap.call_with_frames_removed(exec, code, module.__dict__)
...
class SourceLoader(_LoaderBasics):
    ...
    def source_to_code(self, data, path, *, _optimize=-1):
        ...
        """
        return _bootstrap.call_with_frames_removed(
...
class ExtensionFileLoader(FileLoader, _LoaderBasics):
    ...
    def create_module(self, spec):
        ...
        module = _bootstrap.call_with_frames_removed(_imp.create_dynamic, spec)
        _bootstrap._verbose_message(
    ...
    def exec_module(self, module):
        ...
        _bootstrap.call_with_frames_removed(_imp.exec_dynamic, module)
        _bootstrap._verbose_message(
...
class FileFinder:
    ...
    def path_hook(cls, *loader_details):
        ...
        def path_hook_for_FileFinder(path):
            """Path hook for static_importlib.machinery.FileFinder."""
...
def _setup(_bootstrap_module):
    """Setup the path-based importers for static_importlib by importing needed
    ...
    for builtin_os, path_separators in os_details:
        ...
        raise ImportError("static_importlib requires posix or nt")
