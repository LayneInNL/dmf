...
def _setup(_bootstrap_module):
    ...
    setattr(self_module, "_thread", sys.modules["_thread"])

    # Directly load the _weakref module (needed during bootstrap).
    setattr(self_module, "_weakref", sys.modules["_weakref"])
...
def _install(_bootstrap_module):
    ...
    sys.analysis_path_hooks.extend([FileFinder.path_hook(*supported_loaders)])
    sys.analysis_meta_path.append(PathFinder)
